...
>>>>>>> 37bd0fb3e9fa1e847047297f12e58588aa8a1cff
            self.main = Dashboard()
            self.main.show()
            print(valid)
...
class Dashboard(QMainWindow):
    def __init__(self):
        ...
        ##navigation to pages
        self.ui.pushButton.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Dashboard))
        self.ui.pushButton_2.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Projects))
        self.ui.pushButton_3.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Tickets))
        self.ui.pushButton_4.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Boards))
        self.ui.pushButton_5.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Calendar))
        self.ui.pushButton_6.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Analysis))
        self.ui.pushButton_7.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Messages))
        self.ui.pushButton_8.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Worklog))
        self.ui.pushButton_9.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Settings))
        ...
        self.ui.pushButton_23.clicked.connect(lambda: self.ui.stackedWidget_2.setCurrentWidget(self.ui.member1))
    def setMessage(self):
