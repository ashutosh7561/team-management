...
"}")
    ...
    def retranslateUi(self, DashBoard):
        ...
        self.label_11.setText(QCoreApplication.translate("DashBoard", u"User Settings", None))
        self.label_12.setText(QCoreApplication.translate("DashBoard", u"App Settings", None))
